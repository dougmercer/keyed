...
rectangles = Group(
    [
        Rectangle(x=scene.nx(0.2), y=scene.ny(0.3), width=40, height=60).translate(y=100, start=0, end=24),
        Rectangle(x=scene.nx(0.4), y=scene.ny(0.3), width=50, height=70).translate(y=500, start=0, end=24),
        Rectangle(x=scene.nx(0.6), y=scene.ny(0.3), width=60, height=80),
        Rectangle(x=scene.nx(0.8), y=scene.ny(0.3), width=70, height=90),
        Rectangle(x=scene.nx(0.9), y=scene.ny(0.3), width=80, height=100).translate(y=-100, start=0, end=24),
    ]
)
...
circles = Group(
    [
        Circle(x=scene.nx(0.2), y=y, radius=20),
        Circle(x=scene.nx(0.4), y=y, radius=25),
        Circle(x=scene.nx(0.8), y=y, radius=30),
        Circle(x=scene.nx(0.9), y=y, radius=35),
        Circle(x=scene.nx(0.95), y=y, radius=40),
    ]
)
