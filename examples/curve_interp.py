...
from keyed import Animation, Circle, Code, Curve, Scene, Selection, easing, tokenize
...
curve = Curve(scene.ctx, points, alpha=0.5, line_width=50, buffer=10, tension=0.5)
