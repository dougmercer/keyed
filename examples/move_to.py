...
points = {
    "center": Circle(x=scene.nx(0.5), y=scene.ny(0.5), radius=5, color=(1, 0, 0)),
    "top": Circle(x=scene.nx(0.5), y=scene.ny(0.2), radius=5, color=(0, 1, 0)),
    "bottom": Circle(x=scene.nx(0.5), y=scene.ny(0.8), radius=5, color=(0, 0, 1)),
}

# Create test objects
rect = Rectangle(x=110, y=60, width=200, height=100, color=(1, 1, 0))
circle = Circle(x=10, y=10, radius=50, color=(0, 1, 1))
