...
r1.animate("x", Animation(0, 6, 0, 10, animation_type=AnimationType.ADDITIVE))
r1.animate("y", Animation(0, 6, 0, 10, animation_type=AnimationType.ADDITIVE))
c1.animate("x", Animation(0, 6, 0, -10, animation_type=AnimationType.ADDITIVE))
c1.animate("y", Animation(0, 6, 0, -10, animation_type=AnimationType.ADDITIVE))
